...
namespace Covenant.API.Models
{
    ...
    public partial class HttpProfile
    {
        ...
        /// 'Bridge'</param>
        public HttpProfile(int? id = default(int?), string name = default(string), string description = default(string), ProfileType? type = default(ProfileType?), string messageTransform = default(string), IList<string> httpUrls = default(IList<string>), IList<HttpProfileHeader> httpRequestHeaders = default(IList<HttpProfileHeader>), IList<HttpProfileHeader> httpResponseHeaders = default(IList<HttpProfileHeader>), string httpPostRequest = default(string), string httpGetResponse = default(string), string httpPostResponse = default(string))
        {
            Id = id;
            Name = name;
