...
namespace Covenant.API.Models
{
    ...
    public partial class Regsvr32Launcher
    {
        ...
        /// Initializes a new instance of the Regsvr32Launcher class.
        /// </summary>
        /// <param name="type">Possible values include: 'Binary',
        ...
        /// 'VBScript'</param>
        public Regsvr32Launcher(int? id = default(int?), int? listenerId = default(int?), int? implantTemplateId = default(int?), string name = default(string), string description = default(string), LauncherType? type = default(LauncherType?), DotNetVersion? dotNetVersion = default(DotNetVersion?), RuntimeIdentifier? runtimeIdentifier = default(RuntimeIdentifier?), bool? validateCert = default(bool?), bool? useCertPinning = default(bool?), string smbPipeName = default(string), int? delay = default(int?), int? jitterPercent = default(int?), int? connectAttempts = default(int?), System.DateTime? killDate = default(System.DateTime?), string launcherString = default(string), string stagerCode = default(string), OutputKind? outputKind = default(OutputKind?), bool? compressStager = default(bool?), byte[] diskCode = default(byte[]), ScriptingLanguage? scriptLanguage = default(ScriptingLanguage?), string progId = default(string), string parameterString = default(string), string dllName = default(string))
        {
            Id = id;
        ...
        /// <summary>
        /// Gets or sets possible values include: 'Binary', 'ServiceBinary',
        /// 'ShellCode', 'PowerShell', 'MSBuild', 'InstallUtil', 'Regsvr32',
        /// 'Mshta'
        /// </summary>
