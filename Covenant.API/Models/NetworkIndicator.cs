...
namespace Covenant.API.Models
{
    ...
    public partial class NetworkIndicator
    {
        ...
        public NetworkIndicator(int? id = default(int?), IndicatorType? type = default(IndicatorType?), string protocol = default(string), string domain = default(string), string ipAddress = default(string), int? port = default(int?), string uri = default(string))
        {
            Id = id;
            Type = type;
            Protocol = protocol;
