...
namespace Covenant.API.Models
{
    ...
    {
        /// <summary>
        /// Initializes a new instance of the ScreenshotEvent class.
        /// </summary>
        ...
        /// 'Complete'</param>
        public ScreenshotEvent(string name, int? id = default(int?), System.DateTime? time = default(System.DateTime?), string messageHeader = default(string), string messageBody = default(string), EventLevel? level = default(EventLevel?), EventType? type = default(EventType?), string context = default(string), int? gruntCommandId = default(int?), DownloadProgress? progress = default(DownloadProgress?), string fileName = default(string), long? fileLength = default(long?))
        {
            Id = id;
            Name = name;
            Time = time;
