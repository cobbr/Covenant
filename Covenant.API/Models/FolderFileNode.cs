...
namespace Covenant.API.Models
{
    ...
    public partial class FolderFileNode
    {
        /// <summary>
        /// Initializes a new instance of the FolderFileNode class.
        /// </summary>
        public FolderFileNode()
        {
            CustomInit();
        }
        ...
        /// Initializes a new instance of the FolderFileNode class.
        /// </summary>
        public FolderFileNode(string fullName, string name, int? id = default(int?), long? length = default(long?), System.DateTime? creationTime = default(System.DateTime?), System.DateTime? lastAccessTime = default(System.DateTime?), System.DateTime? lastWriteTime = default(System.DateTime?), bool? enumerated = default(bool?), int? parentId = default(int?), int? gruntId = default(int?))
        {
            Id = id;
            FullName = fullName;
            Name = name;
