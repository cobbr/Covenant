...
namespace Covenant.API.Models
{
    ...
    public partial class CapturedPasswordCredential
    {
        ...
        /// 'Ticket'</param>
        public CapturedPasswordCredential(int? id = default(int?), CredentialType? type = default(CredentialType?), string domain = default(string), string username = default(string), string password = default(string))
        {
            Id = id;
            Type = type;
            Domain = domain;
