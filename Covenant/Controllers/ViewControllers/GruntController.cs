...
namespace Covenant.Controllers
{
    ...
    public class GruntController : Controller
    {
        ...
        public GruntController(IConfiguration configuration)
        {
        ...
        {
            return View(await _client.ApiGruntsGetAsync());
        }
        ...
        public async Task<IActionResult> Interact(int? id)
        {
            ...
            Grunt grunt = await _client.ApiGruntsByIdGetAsync(id ?? default);
            if (grunt == null)
            {
                return NotFound();
            }
            ViewBag.GruntTaskings = await _client.ApiGruntsByIdTaskingsDetailGetAsync(id ?? default);
            return View(grunt);
        }
    }
}
