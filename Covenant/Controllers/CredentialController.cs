...
namespace Covenant.Controllers
{
    ...
    public class CredentialController : Controller
    {
        ...
        public IEnumerable<CapturedCredential> GetCredentials()
        {
        ...
        public IEnumerable<CapturedPasswordCredential> GetPasswordCredentials()
        {
        ...
        public IEnumerable<CapturedHashCredential> GetHashCredentials()
        {
        ...
        public IEnumerable<CapturedTicketCredential> GetTicketCredentials()
        {
        ...
        {
            var credential = _context.Credentials.Where(C => C.Type == CapturedCredential.CredentialType.Password)
        ...
        {
            var credential = _context.Credentials.Where(C => C.Type == CapturedCredential.CredentialType.Hash)
                                                 .FirstOrDefault(c => c.Id == id);
            if (credential == null)
            {
                return NotFound();
        ...
        {
            var credential = _context.Credentials.Where(C => C.Type == CapturedCredential.CredentialType.Ticket)
                                                 .FirstOrDefault(c => c.Id == id);
            if (credential == null)
            {
                return NotFound();
        ...
        {
            CapturedPasswordCredential matching_passwordCredential = (CapturedPasswordCredential) _context.Credentials.
                FirstOrDefault(c => 
            ...
            _context.SaveChanges();
            return Ok(matching_passwordCredential);
        }
        ...
        {
            CapturedHashCredential matching_hashCredential = (CapturedHashCredential)_context.Credentials.
                FirstOrDefault(c =>
            ...
            _context.SaveChanges();
            return Ok(matching_hashCredential);
        }
        ...
        {
            CapturedTicketCredential matching_ticketCredential = (CapturedTicketCredential)_context.Credentials.
                FirstOrDefault(c =>
            ...
            _context.SaveChanges();
            return Ok(matching_ticketCredential);
        }
