...
namespace Covenant.Controllers
{
    ...
    public class GruntTaskingApiController : Controller
    {
        ...
        {
            List<GruntTasking> gruntTaskings = _context.GruntTaskings.ToList();
            foreach (GruntTasking gruntTasking in gruntTaskings)
            {
                gruntTasking.TaskingMessage = "";
                gruntTasking.GruntTaskOutput = "";
            }
            return gruntTaskings;
        }

        // GET: api/taskings/detail
        // <summary>
        // Get GruntTaskings w/ detail
        // </summary>
        [HttpGet("taskings/detail", Name = "GetAllGruntTaskingsDetail")]
        public ActionResult<IEnumerable<GruntTasking>> GetAllGruntTaskingsDetail()
        {
        ...
        {
            List<GruntTasking> gruntTaskings = _context.GruntTaskings.Where(GT => GT.GruntId == id).ToList();
            foreach (GruntTasking gruntTasking in gruntTaskings)
            {
                gruntTasking.TaskingMessage = "";
                gruntTasking.GruntTaskOutput = "";
        ...
        // GET: api/grunts/{id}/taskings/detail
        // <summary>
        // Get GruntTaskings for Grunt w/ detail
        // </summary>
        [HttpGet("grunts/{id}/taskings/detail", Name = "GetGruntTaskingsDetail")]
        public ActionResult<IEnumerable<GruntTasking>> GetGruntTaskingsDetail(int id)
        {
        ...
        // GET api/grunts/{id}/taskings/{tid}
        // <summary>
        // Get a GruntTasking
        // </summary>
        [HttpGet("grunts/{id}/taskings/{tid}", Name = "GetGruntTasking")]
        public ActionResult<GruntTasking> GetGruntTasking(int id, int tid)
        {
        ...
        // GET api/grunts/{id}/taskings/{tid}/detail
        // <summary>
        // Get a GruntTasking w/ detail
        // </summary>
        [HttpGet("grunts/{id}/taskings/{tid}/detail", Name = "GetGruntTaskingDetail")]
        ...
        // PUT api/grunts/{id}/taskings/{tid}
        // <summary>
        // Edit a GruntTasking
        // </summary>
        ...
        // DELETE api/grunts/{id}/taskings/{tid}
        // <summary>
        // Delete a GruntTasking
        // </summary>
        [HttpDelete("grunts/{id}/taskings/{tid}", Name = "DeleteGruntTasking")]
