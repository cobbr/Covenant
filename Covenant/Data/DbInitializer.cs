            ...
            if (!context.GruntTasks.Any())
            {
				var GruntTasks = new List<GruntTask>
				{
					...
					new GruntTask
					{
						...
						ReferenceAssemblies = String.Join(",", new List<string> { "System.Management.Automation.dll" }),
                    ...
                    new GruntTask
                    {
                        ...
                        ReferenceAssemblies = String.Join(",", new List<string> { "System.DirectoryServices.dll", "System.IdentityModel.dll" }),
