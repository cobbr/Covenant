...
namespace Covenant.API.Models
{
    ...
    public partial class GruntTaskOption
    {
        ...
        /// Initializes a new instance of the GruntTaskOption class.
        /// </summary>
        public GruntTaskOption(int? id = default(int?), string name = default(string), string value = default(string), string defaultValue = default(string), string description = default(string), IList<string> suggestedValues = default(IList<string>), bool? optional = default(bool?), bool? displayInCommand = default(bool?), int? gruntTaskId = default(int?))
        {
            Id = id;
            Name = name;
            Value = value;
